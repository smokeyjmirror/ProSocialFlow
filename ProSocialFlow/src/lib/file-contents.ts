  ...
  'docs/backend.json': `
{
  "entities": {
    "TopicHistory": {
      ...
      "title": "TopicHistory",
      "type": "object",
      "description": "Stores the recent topic history for each category to avoid repetition.",
      "properties": {
        "category": {
          "type": "string",
          "description": "The category (e.g., science, technology, politics) to which the topic history belongs."
        },
        "recentTopics": {
          "type": "array",
          "description": "An array of the most recent topics used for the given category.",
          "items": {
            "type": "string"
          }
        }
  ...
  "firestore": {
    "/topic_history/{category}": {
      "schema": {
        "$ref": "#/entities/TopicHistory"
      },
      "description": "Stores the recent topic history for each category. The category name is used as the document ID for efficient retrieval."
    }
  }
}
`,
...
service cloud.firestore {
  match /databases/{database}/documents {
    // Allow read access to topic history for all users.
    // Allow write access only to authenticated server processes (like our Genkit flow),
    // which prevents unauthorized client-side modifications.
    match /topic_history/{category} {
      allow read: if true;
...
`,
  'src/ai/flows/generate-image-of-the-day.ts': `
'use server';
/**
...
`,
  'src/ai/flows/generate-topic-ideas.ts': `
'use server';
/**
...
@layer base {
  :root {
    --background: 260 50% 96%;
    --foreground: 276 10% 25%;
    --card: 0 0% 100%;
    --card-foreground: 276 10% 25%;
    --popover: 0 0% 100%;
    --popover-foreground: 276 10% 25%;
    --primary: 265 60% 55%;
    --primary-foreground: 0 0% 98%;
    --secondary: 260 50% 92%;
    --secondary-foreground: 276 10% 25%;
    --muted: 260 50% 92%;
    --muted-foreground: 276 5% 55%;
    --accent: 239 29% 53%;
...
`,
  'src/components/app/file-navigator.tsx': `
'use client';
...
`,
  'src/components/app/post-card.tsx': `
'use client';
...
`,
  'src/components/app/post-queue.tsx': `
import type { Post } from '@/app/page';
...
export const firebaseConfig = {
  "projectId": "studio-7380593709-f6f1e",
  "appId": "1:1070952053756:web:016ecafa8edc5c5feed079",
  "apiKey": "AIzaSyCaqpCxvE3KqNAcu5tK-4PiI5V8PacUAu0",
  "authDomain": "studio-7380593709-f6f1e.firebaseapp.com",
  "measurementId": "",
  "messagingSenderId": "1070952053756"
};
`,
